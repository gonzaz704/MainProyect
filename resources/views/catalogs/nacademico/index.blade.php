...
@section('content')
    ...
    <script type="text/javascript" src="{{URL::to('/js/catalogs/nacademico/NAcademico_Catalog.js')}}"></script>
	...
	<script type="text/javascript">
		...
		var callback = function(){
		    ...
		    lang_path   = "";
            base_path   = '{!! action("NivelAcademicoController@get_datatable") !!}';
            to_save   = '{!! action("NivelAcademicoController@to_save") !!}';
            to_show   = "{!! action('NivelAcademicoController@show', [ 'id' => 'num_param']) !!}";

            obj_cat = new NAcademico_Catalog(lang_path, base_path);
