...
@section('content') 
    <form method="POST" action="{{action('PapersController@save')}}" enctype="multipart/form-data">
...
8 Now it is finished, go and show it to anyone that is not specialized in the topic you have written about, if they understand it, you have done a very good job</br></br></br>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="topic" name="author_name" required>
        </div>
        <div class="form-group">
            <label for="topic">@lang('PapersCreate.Author(email)')</label>
            <input type="text" class="form-control" id="topic" name="author">
        </div>
        {{-- <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tutors" name="tutors" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" id="editor" name="abstract"></textarea>
        </div>
        <br>
